      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-gray-300 text-sm mb-4">
              Empowering homeowners to sell their properties independently, without traditional real estate agents. Save thousands in commission fees while maintaining full control of your sale.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/resources/staging" className="text-gray-300 hover:text-blue-400 transition-colors">
                  Home Staging Tips
                </Link>
              </li>
              <li>
                <Link href="/resources/legal" className="text-gray-300 hover:text-blue-400 transition-colors">
                  Legal Resources
                </Link>
              </li>
              <li>
                <Link href="/success-stories" className="text-gray-300 hover:text-blue-400 transition-colors">
                  Success Stories
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/browse" className="text-gray-300 hover:text-blue-400 transition-colors">
                  Browse Homes
                </Link>
              </li>
              <li>
                <Link href="/how-to-buy-fsbo" className="text-gray-300 hover:text-blue-400 transition-colors">
                  How to Buy FSBO
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/inspection-guide" className="text-gray-300 hover:text-blue-400 transition-colors">
                  Inspection Guide
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="text-sm text-gray-400">
            © 2025 FSBO Platform. All rights reserved.
          </div>
